  ...
  return (
    <div className="bg-gradient-to-tr from-violet-400 to-violet-700 relative h-screen w-screen overflow-x-hidden">
      ...
      <div className="absolute z-40 inset-0 flex flex-col justify-center items-center max-w-xl mx-auto text-center">
        ...
        <Atropos className="my-atropos" shadowScale={0.1} highlight={false}>
          <div className="space-y-8">
            ...
            <div className="flex flex-col" data-atropos-offset="-5">
              ...
              <div className="w-full animate-zoom-in-out">
                <img
              ...
              <div
                ...
                <a
                  href="https://github.com/upscayl/upscayl/releases/download/v2.5.1/upscayl-2.5.1-linux.AppImage"
                  target="_blank"
                  rel="noreferrer">
                ...
                <a
                  href="https://github.com/upscayl/upscayl/releases/download/v2.5.1/upscayl-2.5.1-win.exe"
                  target="_blank"
                  rel="noreferrer">
        ...
        <footer className="fixed z-50 bottom-1 text-violet-200/50">
          Made by{" "}
