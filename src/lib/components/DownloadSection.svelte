...
<Modal bind:showModal={showLinuxModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-linux.AppImage"
				target="_blank"
			...
			>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-linux.deb"
				target="_blank"
				rel="noreferrer noopener">DEB (Debian/Ubuntu based)</a
			>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-linux.rpm"
				target="_blank"
				rel="noreferrer noopener">RPM (Fedora based)</a
			>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-linux.zip"
				target="_blank"
...
<Modal bind:showModal={showMacModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-mac.dmg"
				target="_blank"
...
<Modal bind:showModal={showWindowsModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/upscayl/upscayl/releases/download/v2.7.5/upscayl-2.7.5-win.exe"
				target="_blank"
